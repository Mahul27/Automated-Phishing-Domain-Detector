...
param_distributions = { #This is used to define a dictionary of hyperparameters and their corresponding values for the XGBoost model
    'n_estimators': [100, 200, 300, 400, 500], #This is used to define the number of trees in the forest
    'max_depth': [3, 5, 7, 9, 11], #This is used to define the maximum depth of the tree
    'learning_rate': [0.01, 0.05, 0.1, 0.2], #This is used to define the learning rate of the model
    'subsample': [0.6, 0.8, 1.0], #This is used to define the fraction of samples to be used for fitting the individual base learners
    'colsample_bytree': [0.6, 0.8, 1.0], #This is used to define the fraction of features to be used for fitting the individual base learners
}

base_model = XGBClassifier(random_state=42) #This is used to create an instance of the XGBClassifier class

random_search = RandomizedSearchCV(estimator=base_model, param_distributions=param_distributions, n_iter=10, cv=5, scoring='roc_auc', random_state=42) #This is used to create an instance of the RandomizedSearchCV class with the base model and the parameter grid
...
print("Best Recall score found: ", random_search.best_score_) #This is used to print the best ROC AUC score found by the random search model
