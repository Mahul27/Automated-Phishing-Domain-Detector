...
model = XGBClassifier(random_state=42) #This is used to create an instance of the XGBClassifier class
model.fit(X_train, Y_train) #This is used to fit the model to the training data

#print("XGBoost Model trained successfully!") #This is used to print a message indicating that the model has been trained successfully
...
#print("-------------------------------------------------")
#print("XGBoost Evaluation metrics (Default):")
