...
xgboost_model = XGBClassifier(random_state=42) #This is used to create an instance of the XGBClassifier class
...
voting_model = VotingClassifier(estimators=[('xgb', xgboost_model), ('lgbm', lightgbm_model)], voting='soft') #This is used to create an instance of the VotingClassifier class with the XGBoost and LightGBM models as estimators
